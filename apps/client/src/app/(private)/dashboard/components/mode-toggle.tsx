	...
	return (
		<Tabs value={mode} onValueChange={(v) => onChange(v as 'visual' | 'text')} className="w-fit">
			<TabsList className="border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950">
				<TabsTrigger value="visual" className="text-xs font-mono font-bold data-[state=active]:text-cyan-600">
					Visual
				</TabsTrigger>
				<TabsTrigger value="text" className="text-xs font-mono font-bold data-[state=active]:text-cyan-600">
					Texto
				</TabsTrigger>
			</TabsList>
		</Tabs>
