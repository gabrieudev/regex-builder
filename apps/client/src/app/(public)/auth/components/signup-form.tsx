				...
				<FormField
					...
					render={({ field }) => (
						<FormItem>
							...
							<FormControl>
								<Input placeholder="exemplo@exemplo.com" type="email" autoComplete="email" {...field} />
							</FormControl>
							<FormMessage />
						</FormItem>
					)}
								...
								<TooltipProvider>
									<Tooltip>
										...
										<TooltipContent side="top" className="max-w-xs">
											<p>
												A senha deve conter pelo menos 6 caracteres. Para uma senha forte, use maiúsculas, minúsculas, números e
